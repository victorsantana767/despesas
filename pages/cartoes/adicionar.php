...
<body>
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <main class="p-4">
                <h1 class="mb-4">Adicionar Novo Cartão</h1>

                <?php if (isset($_GET['error'])): ?>
                    <div class="alert alert-danger mb-3">
                        <i class="bi bi-exclamation-triangle-fill me-2"></i>
                        Ocorreu um erro ao salvar o cartão. Por favor, tente novamente.
                    </div>
                <?php endif; ?>
                        ...
                        <form action="../../actions/salvar_cartao.php" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="dia_fechamento_fatura" name="dia_fechamento_fatura" min="1" max="31" required>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="dia_vencimento_fatura" class="form-label">Dia do Vencimento da Fatura</label>
                                    <input type="number" class="form-control" id="dia_vencimento_fatura" name="dia_vencimento_fatura" min="1" max="31" required>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="data_validade_cartao" class="form-label">Validade (MM/AA)</label>
                                    <input type="text" class="form-control" id="data_validade_cartao" name="data_validade_cartao" placeholder="MM/AA" pattern="(0[1-9]|1[0-2])\/([0-9]{2})" maxlength="5" required>
                                </div>
                            </div>

                            <button type="submit" class="btn btn-primary me-2"><i class="bi bi-save me-2"></i>Salvar Cartão</button>
